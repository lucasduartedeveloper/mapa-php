...
<link rel="stylesheet" 
         href="css/anim/loading.css?v=16">
...
<script src="script/authentication.js?v=19"></script>
...
<script src="script/cube-scanner.js?v=201"></script>
